...
## 上上次更新（2026-05-07 / v1.4.9）

- 桌面端版本升级到 `v1.4.9`，正式发布会输出 `crawshrimp-v1.4.9-*` 命名的桌面安装包。
...
| `tiktok-ops-assistant` | TikTok Shop Seller Center / Affiliate Center | 商品评分抓取、联盟达人视频列表采集、视频下载打包 |
...
- `v1.4.9`：暂时关闭应用内自动更新，整理首页脚本卡片展示，并补强运行态回收。
